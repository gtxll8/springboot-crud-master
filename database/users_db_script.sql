CREATE DATABASE  IF NOT EXISTS `userservicedb` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `userservicedb`;
-- MySQL dump 10.13  Distrib 5.7.12, for osx10.9 (x86_64)
--
-- Host: 127.0.0.1    Database: userservicedb
-- ------------------------------------------------------
...
CREATE TABLE `user` (
  ...
  `email` varchar(512) CHARACTER SET utf8 NOT NULL UNIQUE,
